...
if("FALSE" STREQUAL "TRUE")
  set(franka_description_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-franka-description-0.6.0)
  set(franka_description_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-franka-description-0.6.0/obj-x86_64-linux-gnu/devel)
  ...
  set(franka_description_INSTALL_PREFIX /opt/ros/kinetic)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'franka_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND franka_description_EXPORTED_TARGETS ${${franka_description_dep}_EXPORTED_TARGETS})
endforeach()
